        ...
        <div className='flex flex-col gap-y-6 lg:gap-y-0'>
          <div className='flex flex-wrap justify-end items-center gap-y-8'>
            <div className='lg:w-1/2'>
              <div className='text-center xl:ml-[380px] md:text-left'>
              ...
              <div className='relative'>
                ...
                <div className='w-full flex justify-center items-center h-full absolute top-0 bg-overlay'>
                  <div className='text-center lg:text-left py-[50px] md:py-0 px-3 lg:px-0'>
                    <h3 className='font-pops font-bold text-xl lg:text-2xl xl:text-[36px] text-white xl:leading-[54px]'>Modern natural oil and gas refineries.</h3>
          ...
          <div className='flex flex-wrap gap-y-8'>
              ...
              <div className='relative'>
                ...
                <div className='w-full flex justify-center items-center h-full absolute top-0 bg-overlay'>
                  <div className='text-center lg:text-left py-[50px] md:py-0'>
                    <h3 className='font-pops font-bold text-xl lg:text-2xl xl:text-[36px] text-white xl:leading-[54px]'>Supply of national industries.</h3>
                    <button className='py-2.5 px-2.5 md:py-3.5 md:px-[30px] bg-primary rounded-full md:rounded-none text-white hover:bg-green-500 mt-5'>Learn More</button>
                  </div>
                </div>
              </div>
            ...
            <div className='lg:w-1/2'>
              <div className='relative'>
                <img className='lg:h-[225px] xl:h-[410px]' src={servicesthree} alt="" />
                <div className='w-full flex justify-center items-center h-full absolute top-0 bg-overlay'>
                  <div className='text-center lg:text-left py-[50px] md:py-0'>
                    <h3 className='font-pops font-bold text-xl lg:text-2xl xl:text-[36px] text-white xl:leading-[54px]'>National fuel distribution and supply.</h3>
                    <button className='py-2.5 px-2.5 md:py-3.5 md:px-[30px] bg-primary rounded-full md:rounded-none text-white hover:bg-green-500 mt-5'>Learn More</button>
                  </div>
                </div>
              </div>
